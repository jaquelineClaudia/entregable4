    ...
    <div className="content-grid">
      ...
      {users.map((user) => (
        <ul className="card-users-list" key={user.id}>
            ...
            <p>
              <b className='info'>Email </b>{user.email}
            </p>
            <p>
            ...
            <div className='button-content'>  
              <button className='select-button' onClick={() =>editInModal(user)}><i className="fa-solid fa-pen-to-square"></i></button>
              <button className='delete-button' onClick={() => deleteUsers(user.id)}><i className="fa-solid fa-trash"></i></button>
            </div>
